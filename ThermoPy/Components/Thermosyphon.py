...
class thermosyphonBaseClass():
    ...
    def thermosyphon(self):
        ...
        self.p_v = PropsSI('P','T',self.T_v,'Q',1,self.fluid)
        rho_l = PropsSI('D','T',self.T_v,'Q',0,self.fluid)
        rho_v = PropsSI('D','T',self.T_v,'Q',1,self.fluid)
        self.h_lv = PropsSI('H','T',self.T_v,'Q',1,self.fluid)-PropsSI('H','T',self.T_v,'Q',0,self.fluid)
        mu_l = PropsSI('V','T',self.T_v,'Q',0,self.fluid)# liquid viscosity
        self.sigma = PropsSI('I','T',self.T_v,'Q',0,self.fluid)
        ...
        self.T_p = PropsSI('T','P',self.p_p,'Q',0,self.fluid)
...
if __name__=='__main__':
    ...
    thermosyphon = thermosyphonBaseClass(**params)
    ...
    print(thermosyphon.T_v,thermosyphon.p_v,thermosyphon.h_lv,thermosyphon.sigma,thermosyphon.Phi_2,thermosyphon.p_p,thermosyphon.Qdot)
