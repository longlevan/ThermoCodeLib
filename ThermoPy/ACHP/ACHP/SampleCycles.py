from ThermoPy.ACHP.ACHP.Cycle import DXCycleClass,SecondaryCycleClass,F2K
from ThermoPy.ACHP.ACHP.ACHPTools import Write2CSV
...
def SampleSecondaryLoopHPSystem():
    ...
    Cycle.Evaporator.Fins.Air.Tmean=F2K(42)
    Cycle.Evaporator.Fins.Air.Tdb=F2K(42)     #Dry Bulb Temperature
    ...
    Cycle.LineSetSupply.pin=300
    Cycle.LineSetReturn.pin=300
    Cycle.LineSetSupply.Update(**params)
    Cycle.LineSetReturn.Update(**params)
    Cycle.LineSetSupply.OD=0.009525
    Cycle.LineSetSupply.ID=0.007986
