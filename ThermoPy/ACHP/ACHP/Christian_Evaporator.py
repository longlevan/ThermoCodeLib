...
from ThermoPy.ACHP.ACHP.Correlations import f_h_1phase_Tube,ShahEvaporation_Average, LockhartMartinelli,LMPressureGradientAvg,AccelPressureDrop,TwoPhaseDensity
from scipy.optimize import brentq #solver to find roots (zero points) of functions
from scipy.interpolate import interp1d
#import numpy as np
from ThermoPy.ACHP.ACHP.FinCorrelations import WavyLouveredFins,FinInputs,IsFinsClass
from ThermoPy.ACHP.ACHP.DryWetSegment import DWSVals, DryWetSegment
from ThermoPy.ACHP.ACHP.ACHPTools import ValidateFields
import numpy as np
