...
model ExchangeValues "Test problem for the function that exchanges values"
 extends Modelica.Icons.Example;
  parameter Real x = 3;
  Real y;
  Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.ExtendableArray table=
    Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.ExtendableArray()
    "Extentable array, used to store history of rate of heat flows";

algorithm
  y := Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.exchangeValues(
...
Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.exchangeValues</a> by
